...
namespace DarthVader\Cms\Core\Traits;
...
{
    public function __construct(Connection $connection, KernelInterface $kernel, Environment $environment, Security $security)
    {
        parent::__construct($connection, $kernel, $environment, $security);

        $this->_theme = 'paper-dashboard';
    }
